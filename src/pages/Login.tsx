            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="flex items-center py-2">
                <div className="flex items-center">
                  <input
                    id="remember-me"
                    type="checkbox"
                    className="h-4 w-4 rounded border-slate-300 dark:border-slate-600 text-indigo-600 focus:ring-indigo-600 cursor-pointer"
                  />
              ...
              <div className="pt-4">
                <button
                  ...
                  className="group relative w-full rounded-2xl accent-gradient p-[1px] shadow-lg shadow-indigo-500/20 active:scale-[0.98] transition-all"
                >
