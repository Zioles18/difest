...
export function DashboardLayout({ children }: {
    ...
    return (<div className="flex flex-col h-screen overflow-hidden font-sans bg-slate-50 dark:bg-slate-950">
      <div className="relative z-10 p-4 sm:p-6">
        <CardNav logo="/logo.png" logoAlt="NexBiz Logo" items={cardNavItems} baseColor={isDark ? "rgba(15, 23, 42, 0.85)" : "rgba(255, 255, 255, 0.95)"} menuColor={isDark ? "#e2e8f0" : "#1e293b"}/>
      </div>
