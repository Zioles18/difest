...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  useGSAP(
    () => {
      ...
      // Find the nearest scrollable parent (bypasses layout with custom scroll containers)
      const getScroller = (el: HTMLElement): Window | HTMLElement => {
        const overflowEl = el.closest('[class*="overflow-y-auto"], [class*="overflow-auto"], [style*="overflow"]') as HTMLElement | null;
        return (overflowEl && overflowEl !== document.body) ? overflowEl : window;
      };
